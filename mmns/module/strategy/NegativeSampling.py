...
class NegativeSampling(Strategy):
    ...
    def __init__(self, model=None, loss=None, batch_size=256, regul_rate=0.0, l3_regul_rate=0.0, neg_mode='normal', neg_num=1):
    ...
    def forward(self, data):
        score = self.model(data, batch_size=self.batch_size, neg_mode=self.neg_mode, neg_num=self.neg_num)
